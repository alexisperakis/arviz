(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("dd67c20d-9921-4aa4-950e-5fa3932b61f3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'dd67c20d-9921-4aa4-950e-5fa3932b61f3' but no matching script tag was found.")
        }
