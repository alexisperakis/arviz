(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      var element = document.getElementById("5f6108c1-6907-4497-a304-7d8e401541c5");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '5f6108c1-6907-4497-a304-7d8e401541c5' but no matching script tag was found.")
        }
